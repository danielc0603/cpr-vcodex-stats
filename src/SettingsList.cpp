  ...
  static const std::vector<SettingInfo> list = [] {
    std::vector<SettingInfo> settings = {
      ...
      SettingInfo::Enum(StrId::STR_SLEEP_REFRESH, &CrossPointSettings::sleepRefreshMode,
                        ...
                        "sleepRefreshMode", StrId::STR_CAT_DISPLAY),
      ...
      SettingInfo::Toggle(StrId::STR_STATUS, &CrossPointSettings::advancedStatusHeader, "advancedStatusHeader",
      ...
      SettingInfo::Toggle(StrId::STR_BATTERY, &CrossPointSettings::statusBarBattery, "statusBarBattery",
                          StrId::STR_CUSTOMISE_STATUS_BAR),
      SettingInfo::Enum(StrId::STR_STATUS_BAR_POSITION, &CrossPointSettings::statusBarPlacement,
                        {StrId::STR_BOTTOM, StrId::STR_TOP, StrId::STR_HIDE}, "statusBarPlacement",
                        StrId::STR_CUSTOMISE_STATUS_BAR),
    };
