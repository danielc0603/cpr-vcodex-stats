...
static constexpr EntityPair ENTITY_LOOKUP[] = {
    ...
    {"&iacute;", "í"},   {"&icirc;", "î"},      {"&iexcl;", "¡"},      {"&igrave;", "ì"},   {"&image;", "ℑ"},
    {"&infin;", "∞"},    {"&int;", "∫"},        {"&iota;", "ι"},       {"&iquest;", "¿"},   {"&isin;", "∈"},
    {"&iuml;", "ï"},     {"&kappa;", "κ"},      {"&lArr;", "⇐"},       {"&lambda;", "λ"},   {"&lang;", "〈"},
    ...
    {"&psi;", "ψ"},      {"&quot;", "\""},      {"&rArr;", "⇒"},       {"&radic;", "√"},    {"&rang;", "〉"},
    {"&raquo;", "»"},    {"&rarr;", "→"},       {"&rceil;", "⌉"},      {"&rdquo;", "\u201D"}, {"&real;", "\u211C"},
    {"&reg;", "®"},      {"&rfloor;", "⌋"},     {"&rho;", "ρ"},
